...
const itemDetails = {
  '1': {
    ...
    price: 25000,
    description: '2年前に購入したThinkPadです。卒業に伴い出品します。動作確認済み、目立つ傷はありません。充電器も付属します。プログラミングの授業で使用していました。',
    category: '家電',
    condition: '美品',
    event: '春学期フリマ 2025',
    seller: {
...
export function ItemDetail({ itemId, onNavigate }: ItemDetailProps) {
  ...
  const item = itemDetails[itemId as keyof typeof itemDetails] || itemDetails['1'];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border p-4 bg-card rounded-lg">
              ...
              <p className="text-sm mt-2 text-foreground">🚚 受け渡し方法：{item.deliveryMethod}</p>
            </div>
            ...
            <div className="border border-border p-4 bg-card rounded-lg">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-secondary">{item.seller.department}</p>
                </div>
              </div>
