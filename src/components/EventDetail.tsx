...
const eventDetails = {
  "1": {
    ...
    location: "第一体育館",
    description:
      "新学期に向けて、教科書や家電など幅広い商品が出品予定です。春から一人暮らしを始める方にもおすすめです。",
    notes: [
      "入場無料・事前登録不要",
      "現金のみの取引となります",
      "大型商品の配送手配も可能です",
...
export function EventDetail({
  ...
  const event =
    eventDetails[eventId as keyof typeof eventDetails] || eventDetails["1"];
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <section>
          <h3 className="mb-4 text-primary">
            このイベントの出品（{event.items.length}件）
          </h3>
            ...
            {event.items.map((item) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-xl mb-2 text-accent">
